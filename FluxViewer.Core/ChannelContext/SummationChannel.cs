...
{
    public override string Type => "Суммирующий";

    private Double _baseKValue;

    public Double BaseKValue
    {
        get { return _baseKValue; }
        set
        {
    ...
    public SummationChannel(int id, String name, String units, bool display, bool save, Double baseKValue,
        List<Tuple<int, Double>> kValues)
