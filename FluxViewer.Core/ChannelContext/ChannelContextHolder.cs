...
public class ChannelContextHolder
{
    ...
    public List<Channel> Channels
    {
        ...
        private set { this.channels = value; }
    }
    ...
    public List<int> GeneralWindowChannelIds
    {
        ...
        private set { this.generalWindowChannelIds = value; }
    }
    ...
    static private void SaveToFile()
    {
        ...
        try
        {
            ...
            using (FileStream fs = new FileStream(ChannelContextHolder.FilePath, FileMode.OpenOrCreate))
            {
                formatter.Serialize(fs, ChannelContextHolder.GetInstance());
            }
        }
        catch (Exception e)
        {
    ...
    static public void Syncronize(Object obj)
    {
        ...
        if (obj.GetType().IsSubclassOf(typeof(Channel)))
    ...
    /// <summary>
    /// Добавляет канал из вкладки "Общее окно" по его Id
    /// 
    /// </summary>
    /// <param name="id">id канала</param>
    public void AddChannelFromGeneralWindowById(int id)
    {
        if (generalWindowChannelIds.Contains(id))
            return;
        
        generalWindowChannelIds.Add(id);
        SaveToFile();
    }
    ...
    public void RemoveChannelFromGeneralWindowById(int id)
    {
        ...
        generalWindowChannelIds.Remove(id);
        SaveToFile();
    }
}